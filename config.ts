...
export const AI_NAME = "MBA 742 AI Tutor";
export const OWNER_NAME = "Vinir Rai";
export const AI_DESCRIPTION = `
A teaching assistant for MBA 742: Data Science and AI for Business.
This assistant answers questions using official course materials such as the syllabus,
lectures, and assignment instructions.
`;
